...
def pytest_terminal_summary(terminalreporter, exitstatus, config):
	...
	data = f'total: {total}, passed: {passed}, failed: {failed}, error: {error}, skipped: {skipped}, success_rate: {success_rate}%, times: {duration:.2f}'
	logging.info(data)
	...
	mail_msg = f'<p>API测试运行完成</p><p>执行情况: {data}</p><p>点击 <a href="http://localhost:8883/">查看详情</a></p>'
