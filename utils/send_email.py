...
def sendReport(flag, to_addr, from_addr, passwd, smtp_server, smtp_port):
	if flag == 'true':
		resultPath = os.path.join(getDir.proDir, "report/report.html")
		...
		# # print(newFile)
		# # 调用发邮件模块
		sentMail(resultPath, to_addr, from_addr, passwd, smtp_server, smtp_port)
	else:
